  ...
  return (
    <main
      ...
      className={cn(
        ...
        "peer-data-[variant=sidebar]:inset-y-0 peer-data-[variant=sidebar]:h-svh peer-data-[variant=sidebar]:flex-col md:peer-data-[variant=sidebar]:peer-data-[state=expanded]:pl-0 md:peer-data-[variant=sidebar]:peer-data-[state=collapsed]:pl-0",
        "peer-data-[variant=floating]:margin-0 peer-data-[variant=floating]:rounded-none md:peer-data-[variant=floating]:peer-data-[state=expanded]:pl-0 md:peer-data-[variant=floating]:peer-data-[state=collapsed]:pl-0",
        className,
      )}
      {...props}
    />
...
const SidebarContent = React.forwardRef(({ className, ...props }, ref) => {
  return (
    <div
      ...
      className={cn(
        "flex min-h-0 flex-1 flex-col gap-2 overflow-y-auto overflow-x-hidden rounded-md",
        className,
      )}
      {...props}
    />
...
const sidebarMenuButtonVariants = cva(
  "peer flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm outline-none ring-sidebar-ring cursor-pointer transition-[width,height,padding] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-accent data-[active=true]:font-medium data-[active=true]:text-sidebar-accent-foreground data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0",
  {
    variants: {
      variant: {
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        "peer-data-[size=sm]:top-1 peer-data-[size=lg]:top-3.5",
        "group-data-[collapsible=icon]:hidden",
        showOnHover &&
          "group-hover/menu-item:opacity-100 data-[state=open]:opacity-100 md:opacity-0 transition-opacity",
        className,
      )}
      {...props}
    />
...
const SidebarMenuSkeleton = React.forwardRef(({ className, showIcon = false, ...props }, ref) => {
  ...
  return (
    <div
      ...
      className={cn("rounded-md h-8 flex items-center gap-2 px-2 w-full", className)}
      {...props}
    >
      {showIcon && (
...
const SidebarMenuSubItem = React.forwardRef(({ ...props }, ref) => <li {...props} ref={ref} />);
